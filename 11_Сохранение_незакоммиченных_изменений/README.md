...
### Интерактивный режим `git stash -p`

Интерактивный режим для выборочного сохранения изменений в stash:
```sh
Stage this hunk [y,n,q,a,d,j,J,g,/,s,e,?]?
```
| Клавиша | Описание | Категория |
|---------|----------|-----------|
| **y** | Добавить текущий фрагмент в stash | Управление фрагментами |
| **n** | Пропустить текущий фрагмент | Управление фрагментами |
| **q** | Выйти без сохранения stash | Управление фрагментами |
| **a** | Добавить этот и все последующие фрагменты в текущем файле | Управление фрагментами |
| **d** | Пропустить этот и все последующие фрагменты | Управление фрагментами |
| **s** | Разделить большой фрагмент на более мелкие | Навигация и редактирование |
| **e** | Редактировать фрагмент вручную | Навигация и редактирование |
| **j** | Следующий фрагмент (если не показан) | Навигация и редактирование |
| **J** | Следующий фрагмент | Навигация и редактирование |
| **k** | Предыдущий фрагмент (если не показан) | Навигация и редактирование |
| **K** | Предыдущий фрагмент | Навигация и редактирование |
| **g** | Выбрать конкретный фрагмент для перехода | Дополнительные опции |
| **/** | Поиск фрагмента по регулярному выражению | Дополнительные опции |
| **?** | Показать справку по всем опциям | Дополнительные опции |
...
```
## Просмотр содержимого стешей

```sh
git stash show    # показывает краткую информацию
git stash show -p # показывает полную diff-информацию
