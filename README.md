...
|                           | `git revert`                  | `git revert хеш_коммита..хеш_коммита`           | отменить диапазон коммитов. Нужно указать хеш начального коммита, две точки и хеш конечного коммита                               | Безопасная отмена в публичных репозиториях |
